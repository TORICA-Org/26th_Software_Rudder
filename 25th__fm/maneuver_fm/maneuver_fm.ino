...
// 操舵角
const float rudderAngleDeg = 8.0; // 6/29 守山さんの意見により試験的に設定(30→15→8)

// 不感帯割合
const float deadzone = 0.01;

// 各種定数
const float potL_zero = 2915.0;
const float potL_full = 3280.0;
const float potR_zero = 1410.0;
const float potR_full = 820.0;
